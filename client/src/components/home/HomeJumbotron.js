...
function HomeJumbotron(props) {
    return (
        <div className="jumbotron" style={{animation: props.jumboSink}}>
            ...
            {props.makeSesh ? 
                <CollapseForm postSesh={props.postSesh} makeOrFind={props.makeOrFind} datePickerHelper={props.children} noResortMatch={props.noResortMatch} unfilledForm={props.unfilledForm} handleChange={props.handleChange} resorts={props.resorts} makeSesh={props.makeSesh} handleClick={props.handleClick}/>
            :
            <div>
